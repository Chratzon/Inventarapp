...
(async function init() {
  try {
    ...
    console.error(e);
    document.querySelector('main').innerHTML = '<div class="empty"><b>Speicher nicht verfügbar</b>Diese App braucht IndexedDB. Im privaten Modus oder bei blockierten Website-Daten funktioniert sie nicht.</div>';
  }
})();
